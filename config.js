...
global.author = process.env.OWNER_NAME || 'CANYON JUNIOR v 2'
global.botname = process.env.BOT_NAME || 'CANYON JUNIOR '
global.oname = author
...
//Sticker Watermarks
global.packname = process.env.BOT_NAME || 'CANYON JUNIOR -𝐌𝐃 🥵'
global.stkpack = process.env.BOT_NAME || 'CANYON JUNIOR -𝙈𝘿 🥵'
global.stkowner = process.env.OWNER_NAME || '© canyon md v2'

//Watermark
global.maker = process.env.MAKER || 'Made with canyon_junior'
